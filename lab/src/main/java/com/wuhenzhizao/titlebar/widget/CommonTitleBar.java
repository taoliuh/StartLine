 ...
 * <!-- ImageView 资源, 对应leftType_ImageButton -->
 ...
 * <!-- ImageView 资源, 对应rightType_ImageButton -->
 ...
 * <!-- TextView 跑马灯效果, 对应centerType_TextView -->
 ...
 * <!-- 搜索输入框是否可输入 -->
 * <attr name="centerSearchEdiable" format="boolean" />
...
public class CommonTitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            fillStatusBar = array.getBoolean(R.styleable.CommonTitleBar_fillStatusBar,
                    true);
        }
        titleBarColor = array.getColor(R.styleable.CommonTitleBar_titleBarColor,
                Color.parseColor("#ffffff"));
        titleBarHeight = (int) array.getDimension(R.styleable.CommonTitleBar_titleBarHeight,
                ScreenUtils.dp2pxInt(context, 44));
        statusBarColor = array.getColor(R.styleable.CommonTitleBar_statusBarColor,
                Color.parseColor("#ffffff"));
        ...
        bottomLineColor = array.getColor(R.styleable.CommonTitleBar_bottomLineColor,
                Color.parseColor("#dddddd"));
        bottomShadowHeight = array.getDimension(R.styleable.CommonTitleBar_bottomShadowHeight,
                ScreenUtils.dp2pxInt(context, 0));
        ...
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            ...
            leftTextColor = array.getColor(R.styleable.CommonTitleBar_leftTextColor,
                    getResources().getColor(R.color.comm_titlebar_text_selector));
            leftTextSize = array.getDimension(R.styleable.CommonTitleBar_leftTextSize,
                    ScreenUtils.dp2pxInt(context, 16));
            leftDrawable = array.getResourceId(R.styleable.CommonTitleBar_leftDrawable, 0);
            leftDrawablePadding = array.getDimension(R.styleable.CommonTitleBar_leftDrawablePadding,
                    5);
        } else if (leftType == TYPE_LEFT_IMAGEBUTTON) {
            leftImageResource = array.getResourceId(R.styleable.CommonTitleBar_leftImageResource,
                    0);
        } else if (leftType == TYPE_LEFT_CUSTOM_VIEW) {
            leftCustomViewRes = array.getResourceId(R.styleable.CommonTitleBar_leftCustomView,
                    0);
        }
        ...
        if (rightType == TYPE_RIGHT_TEXTVIEW) {
            ...
            rightTextColor = array.getColor(R.styleable.CommonTitleBar_rightTextColor,
                    getResources().getColor(R.color.comm_titlebar_text_selector));
            rightTextSize = array.getDimension(R.styleable.CommonTitleBar_rightTextSize,
                    ScreenUtils.dp2pxInt(context, 16));
        } else if (rightType == TYPE_RIGHT_IMAGEBUTTON) {
            rightImageResource = array.getResourceId(R.styleable.CommonTitleBar_rightImageResource,
                    0);
        } else if (rightType == TYPE_RIGHT_CUSTOM_VIEW) {
            rightCustomViewRes = array.getResourceId(R.styleable.CommonTitleBar_rightCustomView,
                    0);
        }
        ...
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            centerTextColor = array.getColor(R.styleable.CommonTitleBar_centerTextColor,
                    Color.parseColor("#333333"));
            centerTextSize = array.getDimension(R.styleable.CommonTitleBar_centerTextSize,
                    ScreenUtils.dp2pxInt(context, 18));
            centerTextMarquee = array.getBoolean(R.styleable.CommonTitleBar_centerTextMarquee,
                    true);
            centerSubText = array.getString(R.styleable.CommonTitleBar_centerSubText);
            centerSubTextColor = array.getColor(R.styleable.CommonTitleBar_centerSubTextColor,
                    Color.parseColor("#666666"));
            centerSubTextSize = array.getDimension(R.styleable.CommonTitleBar_centerSubTextSize,
                    ScreenUtils.dp2pxInt(context, 11));
        } else if (centerType == TYPE_CENTER_SEARCHVIEW) {
            centerSearchEditable = array.getBoolean(R.styleable.CommonTitleBar_centerSearchEditable,
                    true);
            centerSearchBgResource = array.getResourceId(R.styleable.CommonTitleBar_centerSearchBg,
                    R.drawable.comm_titlebar_search_gray_shape);
            centerSearchRightType = array.getInt(R.styleable.CommonTitleBar_centerSearchRightType,
                    TYPE_CENTER_SEARCH_RIGHT_VOICE);
        } else if (centerType == TYPE_CENTER_CUSTOM_VIEW) {
            centerCustomViewRes = array.getResourceId(R.styleable.CommonTitleBar_centerCustomView,
                    0);
        }
    ...
    private void initGlobalViews(Context context) {
        ViewGroup.LayoutParams globalParams =
        ...
        // 计算主布局高度
        if (showBottomLine) {
            mainParams.height = titleBarHeight - Math.max(1,
                    ScreenUtils.dp2pxInt(context, 0.4f));
        } else {
        ...
        if (showBottomLine) {
            ...
            LayoutParams bottomLineParams = new LayoutParams(MATCH_PARENT,
                    Math.max(1, ScreenUtils.dp2pxInt(context, 0.4f)));
            ...
            LayoutParams bottomShadowParams = new LayoutParams(MATCH_PARENT,
                    ScreenUtils.dp2pxInt(context, bottomShadowHeight));
        ...
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            ...
            if (leftDrawable != 0) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
                    tvLeft.setCompoundDrawablesRelativeWithIntrinsicBounds(
                            leftDrawable, 0, 0, 0);
                } else {
            ...
            // 初始化自定义View
            viewCustomLeft = LayoutInflater.from(context).inflate(leftCustomViewRes, rlMain,
                    false);
    ...
    private void initMainRightViews(Context context) {
        ...
        if (rightType == TYPE_RIGHT_TEXTVIEW) {
            ...
            // 初始化自定义view
            viewCustomRight = LayoutInflater.from(context)
                    .inflate(rightCustomViewRes, rlMain, false);
    ...
    private void initMainCenterViews(Context context) {
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            LinearLayout.LayoutParams centerTextParams =
            ...
            LinearLayout.LayoutParams centerSubTextParams =
                    new LinearLayout.LayoutParams(WRAP_CONTENT, WRAP_CONTENT);
            ...
            etSearchHint.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                    ScreenUtils.dp2pxInt(context, 14));
            ...
            // 初始化中间自定义布局
            centerCustomView = LayoutInflater.from(context)
                    .inflate(centerCustomViewRes, rlMain, false);
    ...
    public void onClick(View v) {
        ...
        if (v.equals(llMainCenter) && doubleClickListener != null) {
            ...
            if (centerSearchRightType == TYPE_CENTER_SEARCH_RIGHT_VOICE
                    && TextUtils.isEmpty(etSearchHint.getText())) {
                // 语音按钮被点击
